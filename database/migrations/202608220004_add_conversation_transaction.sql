-- TASK-017: atomic, idempotent conversation and membership creation.
...
begin
  ...
  where conversation_participants.conversation_id = v_conversation_id
    and conversation_participants.user_id not in (
      p_tenant_user_id,
      v_landlord_user_id
    );
  ...
  values
    (v_conversation_id, p_tenant_user_id),
    (v_conversation_id, v_landlord_user_id)
